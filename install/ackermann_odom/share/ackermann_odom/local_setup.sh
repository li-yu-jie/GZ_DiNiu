...
: ${AMENT_CURRENT_PREFIX:="/root/GZ_DiNiu/install/ackermann_odom"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ackermann_odom/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ackermann_odom/environment/path.sh"
