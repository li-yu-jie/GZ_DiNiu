...
: ${AMENT_CURRENT_PREFIX:="/root/GZ_DiNiu/install/steer_closed_loop"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/steer_closed_loop/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/steer_closed_loop/environment/path.sh"
